...
export default function EquiposPage() {
  ...
  // Edicion y eliminacion de equipos
  ...
  async function handleUpdateEquipo(payload) {
    ...
    try {
      ...
      setUpdateErrorMessage(
        getApiErrorMessage(err, "No pudimos actualizar el equipo. Revisá los datos ingresados.")
      );
    } finally {
      setIsUpdating(false);
    }
  ...
  async function handleDeleteEquipo() {
    ...
    try {
      ...
      setDeleteErrorMessage(
        getApiErrorMessage(err, "No pudimos eliminar el equipo. Probá nuevamente.")
      );
    } finally {
      setIsDeleting(false);
    }
          ...
          {editingEquipo ? (
            <EquipoForm
              ...
              initialValues={{
                ...
                rubro: editingEquipo.rubro,
                estado: editingEquipo.estado,
                ubicacion: editingEquipo.ubicacion,
              }}
            />
          ) : null}
        </div>

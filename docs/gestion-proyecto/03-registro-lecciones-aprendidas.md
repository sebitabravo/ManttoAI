...
|----|-----------|----------------------------------------------|----------------------|
| L01 | Técnico/ML | **Random Forest superó expectativas:** Un modelo clásico (scikit-learn) logró 94.1% de accuracy y 93.0% de F1-Score con bajo consumo de CPU. | Evitar Deep Learning para MVPs predictivos si los datos tubulares son suficientes. |

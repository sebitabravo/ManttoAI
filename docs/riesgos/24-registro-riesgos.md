...
| R03 | Retraso importación sensores | Logístico | Media | Medio | 4 | Comprar stock local (MercadoLibre) | Carlos | ✅ Cerrado |
...
| R06 | Falla de Integración Continua (CI) | Calidad | Media | Medio | 4 | Uso de tests automatizados y linting estricto | Carlos | Activo |
